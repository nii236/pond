...
const (
	// BotName is the bot's name
	BotName = "NinjaBot"
	// UserEmail is the bot's Email
	UserEmail = "team+mattermostbot@blockninja.io"
	// UserPassword is the bot's Password
	UserPassword = "password1"
	// UserName is the bot's UserName
	UserName = "ninjabot"
	// UserFirst is the bot's first name
	UserFirst = "Ninja"
	// UserLast is the bot's last name
	UserLast = "Bot"
	// TeamName is the bot's team name
	TeamName = "blockninja"
	// ChannelLogName is the bot's channel name
	ChannelLogName = "botspam"
)
...
func initHTTPClient() *model.Client {
	result := model.NewClient("https://chat.theninja.life")
